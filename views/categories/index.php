          ...
          <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left flex-grow">
            ...
            <div class="mt-2">
                    ...
                    <div class="form-group">
                        ...
                        <span class="error-alert" id="error-color"></span>
                    </div>
            </div>
          </div>
        </div>
        ...
        <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
            <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                    ...
                    <tbody id="categoriesContainer" class="bg-white divide-y divide-gray-200">
                    </tbody>
                    </table>
                </div>
            </div>
...
<div class="fixed z-10 inset-0 overflow-y-auto hidden" aria-labelledby="modal-title" role="dialog" aria-modal="true" id="deleteModal">
        ...
        <div class="relative inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full" id="modal-body">
            ...
            <div class="sm:flex sm:items-start">
                ...
                <h3 class="text-lg leading-6 font-medium text-gray-900" id="modal-title">Eliminar la categoría:</h3>
                <div class="mt-2">
        ...
        <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
            <input type="text" name="deleteCategoryId" id="deleteCategoryId" value="" class="hidden">
            <button id="deleteCategoryBtn" class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-red-600 text-base font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 sm:ml-3 sm:w-auto sm:text-sm">Eliminar</button>
            <button type="button" type="submit" class="mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm" id="deletCancelBtn">Cancelar</button>
        </div>
        </div>
    </div>
</div>
...
<div class="fixed z-10 inset-0 overflow-y-auto hidden" aria-labelledby="modal-title" role="dialog" aria-modal="true" id="editModal">
  <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
    ...
    <div class="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity" id="outiside-edit-category-modal" aria-hidden="true"></div>
    ...
    <div class="relative inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
          ...
          <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left flex-grow">
            ...
            <div class="mt-2">
                ...
                <div class="form-group">
                    ...
                    <input type="color" name="colorEdit" id="colorEdit" class="form-control">
                    <span class="error-alert" id="error-colorEdit"></span>
                </div>
            </div>
          </div>
        </div>
      ...
      <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
        <button id="editCategoryBtn" type="submit" class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-blue-600 text-base font-medium text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 sm:ml-3 sm:w-auto sm:text-sm">Editar</button>
